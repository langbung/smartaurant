...
public class OnCallWaiterDialog extends DialogFragment {
    TextView tvTitle;
    Button btPlus;
    Button btMinus;
    Button btOrder;
    ...
    public OnCallWaiterDialog() {
        super();
    }

    @SuppressWarnings("unused")
    public static OnCallWaiterDialog newInstance(Bundle bundle) {
        OnCallWaiterDialog fragment = new OnCallWaiterDialog();
